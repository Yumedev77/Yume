...
@testset "YUMEOS.jl" begin
    ...
    @testset "Rate Limiting" begin
        ...
        YUMEOS.TwitterRateLimiter.update_rate_limit(scraper.rate_limiter, endpoint, response)
        @test haskey(scraper.rate_limiter.endpoints, endpoint)
        
        # Test Rate Limit Check
        YUMEOS.TwitterRateLimiter.check_rate_limit(scraper.rate_limiter, endpoint)
